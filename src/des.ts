...
function _Base64_utf8_encode (e: any) {
    e = e.replace(/rn/g, "n");
    var t = "";
...
function _Base64_utf8_decode (e: any) {
    var t = "";
    var n = 0;
    var c1, c2, c3
    var r = c1 = c2 = 0;
 ...
 */
function _DesCreate (key: string, value: string, type: string) {
    var message = value;
    if(type==='decrypt'){
        var requestValue = "";
...
function _DesCreateKeys (key: string) {
